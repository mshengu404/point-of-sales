...
export class AuthService {
    ...
    constructor() {
        this.jwtSecret = process.env.JWT_SECRET || "$2b$12$F9l0ebUHICgO3xnYyfa0EOclTnGAq/87nckImnhuA8RsdK7MqRpzm";
    }
    ...
    private generateToken = (userId: number): string => {
        return jwt.sign({ userId }, this.jwtSecret, { expiresIn: this.tokenExpiry });
    };
}
